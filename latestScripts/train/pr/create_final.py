...
os.chdir(r"D:/Coding/2017/ccbd/MIXED3_mixed up stuff/mixCounters6/mixCounters6/")
mapTime = []
mapResources = []
mapID = []
jobName = []
...
for folder in os.listdir("D:/Coding/2017/ccbd/MIXED3_mixed up stuff/mixCounters6/mixCounters6/"):

    params = folder.split("-")
    #ff.write(params[1] + "," + params[2] + "," + params[3] + "," + params[4] + "," + params[5] + "," + params[6] + "," + "\n")
    z = "D:/Coding/2017/ccbd/MIXED3_mixed up stuff/mixCounters6/mixCounters6/" + folder + "/pagerank"
...
os.chdir(r"D:/Coding/2017/ccbd/MIXED3_mixed up stuff/mixCounters6/pr")
'''
