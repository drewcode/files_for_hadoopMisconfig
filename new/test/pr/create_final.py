...
os.chdir(r"D:/Coding/2017/ccbd/MIXED2/mixCounters4/mixCounters4/")
mapTime = []
mapResources = []
mapID = []
jobName = []
...
for folder in os.listdir("D:/Coding/2017/ccbd/MIXED2/mixCounters4/mixCounters4/"):

    params = folder.split("-")
    #ff.write(params[1] + "," + params[2] + "," + params[3] + "," + params[4] + "," + params[5] + "," + params[6] + "," + "\n")
    z = "D:/Coding/2017/ccbd/MIXED2/mixCounters4/mixCounters4/" + folder + "/pagerank"
...
os.chdir(r"D:/Coding/2017/ccbd/MIXED2/mixCounters4/pr")
'''
